...
public class generator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                Instantiate(gm[1], new Vector3(pos_x, 600f, 0.1f), Quaternion.identity);
            }
            else if (chance > 20 && chance <= 40 && gm.Length > 2) // 10% chance for gm[2]
            {
                Instantiate(gm[2], new Vector3(pos_x, 600f, 0.1f), Quaternion.identity);
            }
            else if (chance > 40 && gm.Length > 3) // 60% chance for gm[3], handled by another script
            {
                Instantiate(gm[3], new Vector3(pos_x, 600f, 0.1f), Quaternion.identity);
            }
